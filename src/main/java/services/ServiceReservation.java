...
public class ServiceReservation {
    ...
    }   public static List<reserve> getReservedServicesByUser(String utilisateur) throws SQLException {
        List<reserve> reservations = new ArrayList<>();
        String req = """
        SELECT r.id, r.event_id, r.service_id, r.date_reservation, r.prix_total, s.nom, s.description, s.prix, s.image_url
        FROM reservation r
